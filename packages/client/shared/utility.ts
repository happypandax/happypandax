...
export function urlstring(
    ...
    const dpath = (typeof window !== 'undefined' ? window.location.pathname + window.location.search : '')
...
export function urlparse(
    ...
    let u = url ?? (typeof window !== 'undefined' ? window.location.pathname + window.location.search : '');
