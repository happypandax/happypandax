...
Page = createReactClass({
    ...
    'render': lambda: e(ui.Grid.Column,
                        e(ui.Segment,
                            e(ui.Label, tr(this, "", "Newest Additions"), attached="top", size="large"),
                            e(Slider,*[e(items.Gallery) for x in range(10)]),
                          ),
                        e(ui.Segment,
                            e(ui.Label, tr(this, "", "Artist Spotlight"), attached="top", size="large"),
                            e(Slider,*[e(items.Gallery) for x in range(10)]),
                          ),
                        e(ui.Segment,
                            e(ui.Label, tr(this, "", "Previously Read"), attached="top", size="large"),
                            e(Slider,*[e(items.Gallery) for x in range(10)]),
                          ),
                        e(ui.Segment,
                            e(ui.Label, tr(this, "", "Based On Today's Tags"), attached="top", size="large"),
                            e(Slider,*[e(items.Gallery) for x in range(10)]),
                          ),
                         e(ui.Segment,
