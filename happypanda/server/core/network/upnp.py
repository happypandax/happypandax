...
# shameless copy from:
# https://github.com/HelloZeroNet/ZeroNet/blob/1d8fe61920fd63fea86f249106229964f3e1e09f/src/util/UpnpPunch.py
...
def _retrieve_igd_profile(url):
    ...
    """
    try:
        return urlopen(url.geturl(), timeout=5).read().decode('utf-8')
    except socket.error:
